package com.chula.harakamall.ui.screens.grocery
...
import com.chula.harakamall.ui.theme.newcalor2
    ...
    Column (
        ...
        Box (){
            ...
            Card (
                ...
                colors = CardDefaults.cardColors(newcalor2)
            ){
                ...
                Row(modifier = Modifier.padding(20.dp)) {
                    ...
                    Row (modifier = Modifier.padding(start = 20.dp).padding(start = 30.dp)) {
                        ...
                        Image(
                            painter = painterResource(R.drawable.cart2),
                            contentDescription = "",
                ...
                Column (
                    ...
                    Image(
                        painter = painterResource(R.drawable.carrir),
...
fun GroceryScreenPreview(){
    GroceryScreen(rememberNavController())
